    ...
    var _layoutbuilder = {
        ...
        delete: function() {
            $('#droppable-container').on('click', '.col-control-buttons > .delete', function() {
                ...
                if( confirm('Are you sure want to delete?') ){
                    ...
                    _layoutbuilder.rearrangeSpan($container);
                }
            });
        ...
        save: function() {
            ...
            $('#btnSaveColSettings').on('click', function() {
                ...
                var name = $('#dlColPosition option:selected').text();
                if (position === null) {
                    position = '';
                }
                ...
                $col.find('>.col-wrap>.col-name').text(name);
...
$(document).ready( function(){
     ...
     */
    function generateLayoutJson($item) {
        var result = null;
        ...
        if ($item.attr('data-zo2-type') == 'row') {
            ...
            $childrenContainer.find('> [data-zo2-type]').each(function() {
                var childItem = generateLayoutJson(jQuery(this));
    ...
    function generateZo2SettingJson () {
        ...
        $rootParent.find('>[data-zo2-type="row"]').each(function() {
            if(count == 0) {
                ...
                ++count;
                var itemJson = generateLayoutJson(jQuery(this));
                if (itemJson != null)
                    json.push(itemJson);
            }
    ...
    function triggerSaveForm(){
        $( "#form-layout-builder" ).submit( function(){
