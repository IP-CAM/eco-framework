			...
			<div class="tab-content" id="tab-content-blogcomment">
				<div class="tab-pane active" id="tab-module-pavblogcomment">
					...
					<table class="table no-border">
							...
							<tr>
							<tr>
								<td class="col-sm-2"><?php echo $objlang->get("entry_useimage"); ?></td>
								<td class="col-sm-10">
									<input class="form-control" type="radio" <?php if($useimage == 'landscape') echo 'checked="true"'; ?>  name="pavbloglatest_module[useimage]" value="landscape"> Land Scape
									<input class="form-control" type="radio" <?php if($useimage == 'portrait') echo 'checked="true"'; ?> name="pavbloglatest_module[useimage]" value="portrait"> Portrait
								</td>
							<tr>
							<!-- //Tab Product -->
							<tr>
