					...
					<input type="hidden" name="pavblog_blog[blog_id]" value="<?php echo $blog['blog_id'];?>"/>
						...
						<div class="tab-content">
							...
							<div id="tab-gallery" class="tab-pane">
								<table class="table">
									<tr>
										<td class="col-sm-2"><?php echo $objlang->get('entry_image_landscape');?></td>
										<td class="col-sm-8">
											<a href="" id="thumb-img-landscape" data-toggle="image" class="img-thumbnail">
												<img src="<?php echo empty($blog['thumb_landscape'])?$no_image:$blog['thumb_landscape']; ?>" alt="" title="" data-placeholder="<?php echo $no_image; ?>" />
											</a>
											 <input type="hidden" name="pavblog_blog[image_landscape]" value="<?php echo $blog['image_landscape']; ?>" id="image_landscape" />
										</td>
									</tr>
									<tr>
										<td class="col-sm-2"><?php echo $objlang->get('entry_image_portrait');?></td>
										<td class="col-sm-8">
											<a href="" id="thumb-img-portrait" data-toggle="image" class="img-thumbnail">
												<img src="<?php echo empty($blog['thumb_portrait'])?$no_image:$blog['thumb_portrait']; ?>" alt="" title="" data-placeholder="<?php echo $no_image; ?>" />
											</a>
											<input type="hidden" name="pavblog_blog[image_portrait]" value="<?php echo $blog['image_portrait']; ?>" id="image_portrait" />
										</td>
									</tr>
									<tr>
