...
window.location = url;
    ...
    $('#zo2-admin-megamenu input[name=\'toolmenu-category\']').autocomplete({
        delay: 500,
        ...
        select: function(event, ui) {
            $('#zo2-admin-megamenu input[name=\'toolmenu-category\']').val(ui.item.label);
            $('#zo2-admin-megamenu input[name=\'toolmenu-category\']').data('id',ui.item.value);
    ...
    $('#zo2-admin-mm-toolcol input[name=\'toolmenu-category\']').autocomplete({
        delay: 500,
        source: function(request, response) {
            $.ajax({
                url: 'index.php?route=catalog/category/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request.term),
        ...
        select: function(event, ui) {
            $('#zo2-admin-mm-toolcol input[name=\'toolmenu-category\']').val(ui.item.label);
            $('#zo2-admin-mm-toolcol input[name=\'toolmenu-category\']').data('id',ui.item.value);
            event.stopPropagation();
            return false;
        },
        focus: function(event, ui) {
