...
class ControllerModuleEcomegamenu extends Controller {
	...
	public function index() {   
		...
		$this->document->addStyle('view/stylesheet/ecomegamenu.css');
		$this->document->addScript('view/javascript/ecomegamenu/jquerycookie.js');
		...
		$this->document->addScript('view/javascript/ecomegamenu/jquery.nestable.js');
