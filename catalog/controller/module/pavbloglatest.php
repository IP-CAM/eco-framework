...
class Controllermodulepavbloglatest extends Controller {
	...
	public function index($setting) {
		...
		foreach( $blogs as $key => $blog ){
			if( $blogs[$key]['image_landscape'] && $setting['useimage'] == 'landscape'){
				$blogs[$key]['thumb'] = $this->model_tool_image->resize($blog['image_landscape'], $setting['width'], $setting['height'] );
			}else if( $blogs[$key]['image_portrait'] && $setting['useimage'] == 'portrait'){
				$blogs[$key]['thumb'] = $this->model_tool_image->resize($blog['image_portrait'], $setting['width'], $setting['height'] );
			}else{
				$blogs[$key]['thumb'] = '';
			}
