...
<div class="<?php echo $class; ?>">
    ...
    <ul class="thumbnails" id="gallery-images">
        ...
        <li class="image-additional"><a class="thumbnail" data-image="<?php echo $image['popup']; ?>" data-zoom-image="<?php echo $image['popup']; ?>" href="#" title="<?php echo $heading_title; ?>"> <img src="<?php echo $image['thumb']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a></li>
        <?php } ?>
        <?php } ?>
    </ul>
    <?php } ?>
