<div id="cart" class="btn-group btn-block">
    <button type="button" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="cart-group dropdown-toggle"><i class="icon icon-handbag"></i> <span id="cart-total"><?php echo $text_items; ?></span></button>
